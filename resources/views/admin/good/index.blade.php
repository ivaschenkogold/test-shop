...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Товары
                        @if(isset($accesses->good->create))
                            <a href="{{route('good.create')}}" class="btn btn-info">Создать</a>
                        @endif
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    @if(isset($accesses->good->show))
                                        <a href="{{route('good.show', ['id' => $good->id])}}" class="btn btn-primary">Просмотр</a>
                                    @endif
        ...
        <div id="delete_good_modal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form action="{{route('good.delete')}}" method="post">
                        @csrf
